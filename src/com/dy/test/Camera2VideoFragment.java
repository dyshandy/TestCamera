...
//	 * {@link android.hardware.camera2.CameraCaptureSession} for preview.
//	 */
...
//		return inflater.inflate(R.layout.dialog_video_input, container,
//				false);
//	}
//
//	@Override
...
//		mButtonVideo = (ImageButton) view.findViewById(R.id.btn_record);
...
//
//	/**
//	 * Gets whether you should show UI with rationale for requesting
//	 * permissions.
//	 * 
//	 * @param permissions
//	 *            The permissions your app wants to request.
...
//								getString(R.string.permission_request)).show(
...
//
//	/**
//	 * Tries to open a {@link CameraDevice}. The result is listened by
//	 * `mStateCallback`.
//	 */
...
//			ErrorDialog.newInstance("错误").show(
//					getChildFragmentManager(), FRAGMENT_DIALOG);
//		} catch (InterruptedException e) {
//			throw new RuntimeException(
...
//
//	/**
//	 * Update the camera preview. {@link #startPreview()} needs to be called in
//	 * advance.
//	 */
...
//	 * to `mTextureView`. This method should not to be called until the camera
...
//			mMediaRecorder.setOrientationHint(INVERSE_ORIENTATIONS
//					.get(rotation));
//			break;
//		}
